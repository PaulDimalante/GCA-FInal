...
%>
	...
	<h2>Scores Admin</h2>
	<form:form action="scoresAdmin" method="POST" modelAttribute="scoresBean">
		<table width = "100%">
			<tbody>
				<tr>
				...
				<tr>
					<td><form:input path="dateOfRound" type="date" placeholder="Date of Round"/></td>
					<td>
					...
					<td hidden="hidden"><form:hidden path="clubId" value="<%=clubId%>"/></td>
				</tr>
			</tbody>
		</table>
		<br>
		...
		<table width="100%">
			<tbody>
				...
				<%for (int p=0;p<4;p++) {
					...
					int midVal = scoresBean.getMemberId()[p];
					int sidVal = scoresBean.getScoreId()[p];
					int fnineVal = scoresBean.getFrontNine()[p];
					int bnineVal = scoresBean.getBackNine()[p];
					int oallVal = scoresBean.getOverAll()[p];
					%>
					<tr style="border:1;">
						<td hidden="hidden"><form:hidden path="<%=sid%>" value="<%=sidVal%>"/></td>
 						<td>
						...
						<td><form action="scoresAdminDelete" method="POST">
								<input type="hidden" value="<%=sidVal%>">
