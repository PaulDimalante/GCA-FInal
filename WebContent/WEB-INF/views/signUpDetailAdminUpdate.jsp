...
<head>
	...
	<title>SignUp Detail Admin Update</title>
	<style><%@include file="../views/DropDown.css"%></style>	
</head>

<%
	String memberName_ = "";
	if (request.getAttribute("memberName") != null) {
		memberName_ = (String) request.getAttribute("memberName");
	}
...
<body>
	...
	<h2>Sign Up Detail Admin Update</h2>
	
	<form:form action="signUpDetailAdminUpdate" method="POST" modelAttribute="signUp">
		Member<input type="text" readonly name="memberName" value="<%=memberName_%>"/><br>
